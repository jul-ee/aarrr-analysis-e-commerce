...
분석 과정은 Pandas, Matplotlib, Seaborn을 활용한 Python 기반 분석으로 진행되었으며,  
고객 유입부터 수익 창출까지의 흐름을 시각화하고 지표화함으로써 마케팅 및 고객 관리 전략 수립의 기반을 마련하는 것을 목표로 합니다.
...
> 본 프로젝트는 고객 행동 데이터를 AARRR 프레임워크에 맞추어 체계적으로 분석하고, 각 단계별 사용자 행동 흐름을 정량화하여 인사이트를 도출하는 데 초점을 두었습니다.
